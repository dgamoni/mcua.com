<?php
/**
 * The template for displaying content in the template-careers.php template.
...
<?php
wp_enqueue_script( 'contactform', tfuse_get_file_uri('js/careersform.js'), array('jquery'), '2.0', true );

$params = array( 'contactform_uri' => tfuse_get_file_uri('theme_config/theme_includes/CAREERSFORM.php') );
    ...
    <div class="comment-form">
        <form action= "" method="post" id="contactForm" class="ajax_form" name="contactForm">
            ...
            <div class="row infieldlabel">
                <label for="message"><?php _e('Enter your message or Letter of Intent (optional)'); ?></label>
            ...
            <div class="row rowSubmit">
                <div class="termsfield"><input type="checkbox" class="checkbox" name="terms" id="terms"> <label for="terms"><?php _e('I agree with','tfuse');?> <a href="#"><?php _e('Terms & Conditions','tfuse');?></a></label></div>

                <input type="submit" value="<?php _e('SEND YOUR APPLICATION','tfuse'); ?>"  id="send" class="btn-submit" />
            </div>
        </form>
    </div>
</div>
