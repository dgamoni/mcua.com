...
$cfg['mods_version'] = '1.1.12';
$cfg['theme_name'] = 'The Practice';
...
$cfg['forum_url'] = 'http://themefuse.com/forum/thepractice-wp/';
$cfg['manual_url'] = 'http://themefuse.com/wp-docs/thepractice/';
